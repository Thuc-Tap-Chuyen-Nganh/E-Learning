...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        header("Location: " . BASE_URL ."admin/admin_quiz_manage.php?lesson_id=$lesson_id&status=updated");
    } else {
        header("Location: " . BASE_URL ."admin/admin_quiz_manage.php?lesson_id=$lesson_id&error=db_error");
    }
}
?>